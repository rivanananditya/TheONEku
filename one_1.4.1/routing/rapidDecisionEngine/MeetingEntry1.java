...
public class MeetingEntry1 {
	 ...
	 */
	public MeetingEntry1(double meetingTime) {
		this.weight = 0;
		this.timestamp = 0;
	 ...
	 */
	public MeetingEntry1(double meetingTime, double timestamp) {
		this.weight = 0;
		this.timestamp = 0;
		this.avgMeetingTime = 0;
		this.dummy = false;
	 ...
	 */
	public MeetingEntry1(double meetingTime, double timestamp, int weight, boolean dummy) {
	 ...
	 */
	public MeetingEntry1(MeetingEntry1 entry) {
	...
	public boolean equals(Object o) {
		if (o instanceof MeetingEntry1) {
			MeetingEntry1 entry = (MeetingEntry1) o;
