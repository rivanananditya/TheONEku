 ...
 */
public class DecisionEngineRapidRouter extends ActiveRouter {

    public static final String PUBSUB_NS = "DecisionEngineRapidRouter";
    ...
    protected RoutingDecisionEngineRapid decider;
    ...
    public DecisionEngineRapidRouter(Settings s) {
        super(s);
    ...
    public MessageRouter replicate() {
        return new DecisionEngineRapidRouter(this);
    }
...
//        tryAllMessagesToAllConnections();
    ...
    public RoutingDecisionEngineRapid getDecisionEngine() {
        return this.decider;
    }
