...
public class DecisionEngineRapidKnapsackRouter extends ActiveRouterForKnapsack {
    ...
    protected RoutingDecisionEngineRapidKnapsack decider;
    ...
    public DecisionEngineRapidKnapsackRouter(Settings s) {
        super(s);
        ...
        decider = (RoutingDecisionEngineRapidKnapsack) routeSettings.createIntializedObject(
    ...
    public void init(DTNHost host, List<MessageListener> mListeners) {
        ...
        decider.initi(host, mListeners);
    }

    public DecisionEngineRapidKnapsackRouter(DecisionEngineRapidKnapsackRouter r) {
        super(r);
        outgoingMessages = new LinkedList<Tuple<Message, Connection>>();
    ...
    public MessageRouter replicate() {
        return new DecisionEngineRapidKnapsackRouter(this);
    }
    ...
    public boolean createNewMessage(Message m) {
        if (decider.newMessage(m)) {
            ...
            decider.updateDelayTableEntryNewMessage(m, getHost());
    ...
    public void changedConnection(Connection con) {
        ...
        DecisionEngineRapidKnapsackRouter otherRouter = (DecisionEngineRapidKnapsackRouter) otherNode.getRouter();
        if (con.isUp()) {
...
//            }
 ...
 performed an information exchange for the given connection.
    ...
    public int receiveMessage(Message m, DTNHost from) {
        ...
        if (stat == 0) {
            decider.updateDelayTableReceiveMsg(m, from, getHost());
        }
        return stat;
    }
...
//        tryMessagesForConnected(sortByQueueMode(outgoingMessages));
    ...
    public RoutingDecisionEngineRapidKnapsack getDecisionEngine() {
        return this.decider;
    }
